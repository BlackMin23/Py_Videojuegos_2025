...
public class PlayerController : MonoBehaviour
{
    ...
    void VidaPlayerT()
    {
        VidapersonajeText.text = $"Vida: {VidaPlayer}";
    }

    void PrintTextEnemigosELiminados()
    {
        KillsText.text = $"kills: {Kills} / {EnemigosVivos}";
    }
}